-- these are for internal use and should not be localized
WhoHas.option_strings = {
   ["WhoHasOptionsPanelEnableButton"]     = "enabled",
   ...
   ["WhoHasOptionsPanelWorldButton"]      = "disableWorldTips",
   ["WhoHasOptionsPanelMinesButton"]      = "mines",
...
WhoHas.option_text = {
   ["WhoHasOptionsPanelEnableButton"]    = WhoHas.text.WhoHasEnableButton,
   ...
   ["WhoHasOptionsPanelWorldButton"]     = WhoHas.text.WhoHasWorldButton,
   ["WhoHasOptionsPanelMinesButton"]     = WhoHas.text.WhoHasMinesButton,
